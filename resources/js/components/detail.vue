...
export default {
   ...
   components: {navigation},
    ...
    created(){
      this.$store.dispatch('user/getUserById',{id: this.$route.params.user_id}).then(({ data }) => {
